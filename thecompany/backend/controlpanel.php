...
class rf_ControlPanel {
	...
	var $optionlist = Array(
		...
		array(
			...
			'options' => array(
				...
				array(
					...
					'type' => 'textarea',
					'default' => 'http://fonts.googleapis.com/css?family=PT+Serif:400,700,400italic,700italic',
				...
				array(
					...
					'type' => 'textarea',
					'default' => 'font-family: "PT Serif", serif;',
		...
		array(
			...
			'options' => array(
				/*array(
					'id' => 'cp_blog_social_share',
					'name' => 'Hide social share buttons',
					'type' => 'checkbox',
					'desc' => 'This options will hide the social share buttons on the blog index, blog tiles and the blog posts'
				),*/
				array(
					'name' => 'Social icons',
					'type' => 'title'
