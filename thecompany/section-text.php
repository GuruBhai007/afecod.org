...
<div id="section-<?php echo $rf_section_post->ID; ?>" class="section <?php if (isset($rf_section_fullwidth) && $rf_section_fullwidth == true) { echo 'fullwidth'; } ?>" style="<?php echo $rf_section_style; ?>">
