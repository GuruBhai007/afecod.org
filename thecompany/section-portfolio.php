...
<div id="section-<?php echo $rf_section_post->ID; ?>" class="section portfolio <?php if (isset($rf_portfolio_filter) && $rf_portfolio_filter != '') echo 'hasfilter'; ?> <?php if (isset($rf_portfolio_upsidedown) && $rf_portfolio_upsidedown == true) echo 'upsidedown'; ?>" style="<?php echo $rf_section_style; ?>">
